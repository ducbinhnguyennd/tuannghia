...
class ScreenSetWeight extends StatefulWidget {
  const ScreenSetWeight({super.key});

  @override
  State<ScreenSetWeight> createState() => _ScreenSetWeightState();
}

class _ScreenSetWeightState extends State<ScreenSetWeight> {
  @override
